...
/**
 * Tutor home page decorator.
 * Shows Add Lesson and Show new Notifications buttons.
 */
public class TutorHomeDecorator extends HomePageDecorator {
    ...
    public TutorHomeDecorator(HomePageComponent component) {
        super(component);
    }
    ...
    public void decorateContent(VBox contentArea) {
        ...
        Button btnAddLesson = createStyledButton("Add Lesson", 280, 55);
        btnAddLesson.setOnAction(event -> Navigator.getInstance().goTo(event, "LessonDetails.fxml"));
        ...
        contentArea.getChildren().addAll(btnAddLesson, btnShowNotifications);
    }
